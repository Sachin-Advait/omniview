...
class AppColors {
  ...
  static const Color cyan = Color(0xFF23BCBA);
  static const Color rosePink = Color(0xFFE44A77);
  static const Color deepRose = Color(0xFFC13E6A);
  static const Color violet = Color(0xFF6F42C1);
  static const Color royalBlue = Color(0xFF3F64F7);
  static const Color sapphireBlue = Color(0xFF3155C4);
